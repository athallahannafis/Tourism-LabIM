  ...
  fetchResult = () => {
    ...
    for (let j = 0; j < this.state.list.length; j++) {
      if (searched.star == 1 && this.state.list[j].rate >= 2) {
        ...
        searched.star == 2 &&
        this.state.list[j].rate < 2 &&
        this.state.list[j].rate >= 3
      ) {
        this.state.list.pop(this.state.list[j]);
      } else if (
        searched.star == 3 &&
        this.state.list[j].rate < 3 &&
        this.state.list[j].rate >= 4
      ) {
        this.state.list.pop(this.state.list[j]);
      } else if (
        searched.star == 4 &&
        this.state.list[j].rate < 4 &&
        lthis.state.ist[j].rate >= 5
      ) {
        this.state.list.pop(this.state.list[j]);
  ...
  render() {
    ...
    return (
      <>
        <ScrollView>
          <View
            ...
            {this.state.checkinValue === 'Tanggal check-in' ? (
              ...
              <Text style={{fontSize: 15, color: 'black', width: 125}}>
                {this.state.checkinValue}
              </Text>
            )}
        ...
        <Modal
          transparent={true}
          visible={this.state.simpleSearchedInfo}
          animationType="slide">
          <View
            style={[
              gs.cardSection,
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      this.setState({
                        ...
                        //simpleSearchResult: false,
                        expandSearchedInfo: true,
        ...
        <Modal
          transparent={true}
          visible={this.state.expandSearchedInfo}
          animationType="slide">
          {/* SEARCH SECTION */}
          <View
            style={[
                ...
                <View style={ats.rowContainer}>
                  <View style={ats.rowContainer}>
                    ...
                    <TouchableOpacity
                      ...
                      <Text style={{fontSize: 15, color: 'black', width: 127}}>
